...
class StrictTabulatedFunctionTest {
    ...
    @Test
    void getCount() {
        TabulatedFunction f1 = new StrictTabulatedFunction(new ArrayTabulatedFunction(X1, Y1));
        TabulatedFunction f2 = new StrictTabulatedFunction(new LinkedListTabulatedFunction(X1, Y1));
    ...
    void setY() {
        ...
        f2.setY(idx, y);
        assertEquals(y, f2.getY(idx), DELTA);
    }
