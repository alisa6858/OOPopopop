...
public class ArrayTabulatedFunctionSerialization {
    ...
    public static void main(String[] args) {
        try (FileOutputStream s = new FileOutputStream("output/serialized array functions.bin")) {
        ...
        try (FileInputStream s = new FileInputStream("output/serialized array functions.bin")) {
