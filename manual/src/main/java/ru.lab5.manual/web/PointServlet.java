...
public class PointServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        log.info("GET /api/points, id={}, functionId={}", idParam, functionIdParam);
        ...
        try (PrintWriter writer = resp.getWriter()) {
            ...
            log.error("Ошибка при обработке GET /api/points", e);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        log.info("POST /api/points, functionId={}, name={}", functionId, name);

        // тут будет сохранение точки в БД
        ...
        try (PrintWriter writer = resp.getWriter()) {
            ...
            log.error("Ошибка при обработке POST /api/points", e);
            resp.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
        }
    }
}
